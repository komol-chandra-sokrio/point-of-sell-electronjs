	...
	return (
		<>
			...
			<section className='my-10'>
				<div className='flex'>
					<div className='w-9/12'>{/* <Bar options={options} data={data} /> */}</div>
					<div className='w-3/12 shadow bg-slate-100 mx-5'>
						<h4 className='text-md font-semibold uppercase text-center py-4 text-gray-700'>
							Top District
						</h4>
						<div className='flex flex-col mx-auto w-full items-center justify-center'>
							<ul className='flex flex-col'>
								<li className='flex flex-row mb-2'>
									<div className='shadow select-none cursor-pointer bg-white dark:bg-gray-800 flex flex-1 items-center p-4'>
										<div className='flex-1 pl-1 md:mr-16'>
											<div className='text-gray-600 dark:text-gray-200 text-sm'>Jhenaidah</div>
										</div>
								...
								<li className='flex flex-row mb-2'>
									<div className='shadow select-none cursor-pointer bg-white dark:bg-gray-800 flex flex-1 items-center p-4'>
										<div className='flex-1 pl-1 md:mr-16'>
											<div className='text-gray-600 dark:text-gray-200 text-sm'>Dhaka</div>
										</div>
										<div className='text-gray-600 dark:text-gray-200 text-xs'>6:00 AM</div>
									</div>
								</li>
								<li className='flex flex-row mb-2'>
									<div className='shadow select-none cursor-pointer bg-white dark:bg-gray-800 flex flex-1 items-center p-4'>
										<div className='flex-1 pl-1 md:mr-16'>
											<div className='text-gray-600 dark:text-gray-200 text-sm'>Chittagong</div>
										</div>
										<div className='text-gray-600 dark:text-gray-200 text-xs'>6:00 AM</div>
									</div>
								</li>
